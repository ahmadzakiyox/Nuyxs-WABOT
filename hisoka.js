...
break
   ...
   //console.log(response.reply)
    ...
    console.error(error);
    m.reply('Terjadi kesalahan saat mencoba menghubungi AI');
  }
            }
	    break
   ...
   let ai = await herc.question({model:"v3-32k",content: text }).then(response => {
     m.reply(response.reply)
   });
   ...
   //console.log(response.reply)
    ...
    m.reply('Terjadi kesalahan saat mencoba menghubungi AI');
	    ...
	    case 'dalle': {
	      m.reply(mess.wait)
		try {
   let ai = await herc.drawImage({model:"dalle",prompt: text, negative_prompt:""}).then(response => {
    hisoka.sendMessage(m.chat, { image: { url: response.url }}, { quoted: m })
   });
   ...
   //console.log(response.reply)
    ...
    m.reply('Terjadi kesalahan saat mencoba menghubungi AI');
	    ...
	    case 'lexica': {
	      m.reply(mess.wait)
		try {
   let ai = await herc.drawImage({model:"lexica",prompt: text, negative_prompt:""}).then(response => {
    hisoka.sendMessage(m.chat, { image: { url: response.url }}, { quoted: m })
   });
   ...
   let ai = await herc.drawImage({model:"prodia",prompt: text, negative_prompt:""}).then(response => {
    hisoka.sendMessage(m.chat, { image: { url: response.url }}, { quoted: m })
   });
   ...
   let ai = await herc.drawImage({model:"simurg",prompt: text, negative_prompt:""}).then(response => {
    hisoka.sendMessage(m.chat, { image: { url: response.url }}, { quoted: m })
   });
   ...
   let ai = await herc.drawImage({model:"animefy",prompt: text, negative_prompt:""}).then(response => {
    hisoka.sendMessage(m.chat, { image: { url: response.url }}, { quoted: m })
   });
   ...
   let ai = await herc.drawImage({model:"raava",prompt: text, negative_prompt:""}).then(response => {
    hisoka.sendMessage(m.chat, { image: { url: response.url }}, { quoted: m })
   });
   ...
   let ai = await herc.drawImage({model:"shonin",prompt: text, negative_prompt:""}).then(response => {
    hisoka.sendMessage(m.chat, { image: { url: response.url }}, { quoted: m })
   });
